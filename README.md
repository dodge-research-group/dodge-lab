...
Our group web site uses the [Wowchemy](https://wowchemy.com) static site generator with the [Hugo Research Group Theme](https://github.com/wowchemy/starter-hugo-research-group). See below for more information.

## Documentation (from Wowchemy)
